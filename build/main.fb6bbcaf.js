      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return fetch('telegram.php', {
            ...
            method: 'POST',
            // метод, которым мы отправляем форму
...
var forms = document.querySelectorAll('form'); // находим все теги form
forms.forEach(function (form) {
  ...
  form.addEventListener('submit', function (e) {
    ...
    var formData = new FormData(this); // собираем все данные из формы
    console.log(formData);
    ajaxSend(formData) // передаем данные из формы в обработчик
    .then(function (response) {
      // если все успешно, то..
      _this.innerHTML = 'Спасибо,<br> Ваше сообщение отправлено в телеграм. В ближайшее время отвечу на почту, указанную Вами в форме.'; /* окно благодарности */
